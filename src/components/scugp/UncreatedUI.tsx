...
import { Ghost, Sparkles, Zap, Infinity, Brain, Globe, History, ShieldCheck, RefreshCw, Radio, Layers, Waves, Sun, Target } from "lucide-react";
    ...
    <div className="space-y-12 animate-in fade-in zoom-in duration-1000">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {[
          ...
          { label: "Silence", val: metrics.silence_frequency, icon: Infinity, color: "text-white" }
        ].map((m, i) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-12">
          <Card className="bg-black border-[12px] border-amber-600 shadow-[0_0_600px_rgba(245,158,11,0.3)] relative overflow-hidden rounded-[8rem] min-h-[950px]">
            ...
            <CardFooter className="relative z-10 p-24 border-t border-amber-900/50 bg-slate-950/50 justify-between items-center">
