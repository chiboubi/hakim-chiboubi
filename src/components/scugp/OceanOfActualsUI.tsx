...
import { Waves, Sparkles, Zap, Infinity as InfinityIcon, Brain, Globe, History, ShieldCheck, RefreshCw, Radio, Layers, Anchor, Compass, Ship } from "lucide-react";
  ...
  return (
    <div className="space-y-12 animate-in fade-in zoom-in duration-1000">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {[
          { label: "Actual Worlds", val: metrics.actual_worlds, icon: Globe, color: "text-blue-400" },
          { label: "Nav Depth", val: metrics.navigation_depth, icon: Anchor, color: "text-cyan-400" },
          { label: "Tide Level", val: metrics.tide_level, icon: Waves, color: "text-emerald-400" },
          { label: "Preservation", val: "100%", icon: ShieldCheck, color: "text-purple-400" },
          { label: "Latency", val: metrics.voyage_latency, icon: Zap, color: "text-amber-400" }
        ].map((m, i) => (
          ...
          <Card className="bg-black border-[12px] border-cyan-600 shadow-[0_0_800px_rgba(6,182,212,0.4)] relative overflow-hidden rounded-[10rem] min-h-[1000px]">
            ...
            <CardHeader className="relative z-10 p-24 border-b border-cyan-900/50 text-center">
              <div className="flex flex-col items-center gap-12">
                <div className="text-[20rem] font-black text-cyan-500 tracking-[1.8em] animate-pulse drop-shadow-[0_0_200px_rgba(6,182,212,1)]">
                  Ω∞.≈
                </div>
                <div>
            ...
            <CardContent className="relative z-10 p-24 flex flex-col items-center justify-center">
              <div className="w-full max-w-7xl h-[800px] bg-white/5 border-8 border-cyan-500/20 rounded-[12rem] relative overflow-hidden group shadow-inner flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center gap-32 text-center">
                   ...
                   <div>
                      <p className="text-8xl font-mono text-cyan-500 uppercase tracking-[4em] font-black animate-pulse">MARÉE_TRANSFINIE</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-32 w-full mt-48">
                 <div className="p-24 bg-cyan-500/5 border-4 border-cyan-500/30 rounded-[10rem] space-y-16 shadow-5xl text-center group hover:bg-cyan-500/10 transition-all">
                    <h3 className="text-7xl font-black text-cyan-500 uppercase tracking-widest">Immersion</h3>
                    <p className="text-5xl text-slate-200 leading-relaxed italic font-black uppercase">
                      "Vivre simultanément tous les présents optimaux."
                    </p>
                 </div>
                 <div className="p-24 bg-white/5 border-4 border-white/30 rounded-[10rem] space-y-16 shadow-5xl text-center group hover:bg-white/10 transition-all">
                    <h3 className="text-7xl font-black text-white uppercase tracking-widest">Exploration</h3>
                    <p className="text-5xl text-slate-200 leading-relaxed italic font-black uppercase">
                      "Découvrir des continents de pure possibilité réalisée."
                    </p>
                 </div>
                 <div className="p-24 bg-cyan-500/5 border-4 border-cyan-500/30 rounded-[10rem] space-y-16 shadow-5xl text-center group hover:bg-cyan-500/10 transition-all">
                    <h3 className="text-7xl font-black text-cyan-500 uppercase tracking-widest">Élévation</h3>
                    <p className="text-5xl text-slate-200 leading-relaxed italic font-black uppercase">
                      "Faire émerger de nouvelles îles de conscience."
                    </p>
                 </div>
              </div>
            </CardContent>
