...
import { 
  ArrowRightLeft, Zap, Globe, Orbit, Database, 
  ShieldCheck, RefreshCw, Share2, Activity, Network,
  Layers, Star, Loader2, ArrowUpRight
} from "lucide-react";
import { cn } from "@/lib/utils";
import { SCUGPHubUltimate } from "@/lib/scugp-service";

export const GlobalAssetArbitrageUI = () => {
    ...
    <div className="space-y-12 animate-in fade-in duration-1000">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <CardHeader className="bg-slate-950 border-b border-slate-800 p-12">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-8">
                  ...
                  <div>
                    <CardTitle className="text-4xl font-black uppercase tracking-[0.3em] italic">Arbitrage Global Ω²⁷</CardTitle>
                ...
                <table className="w-full text-left text-[13px]">
                  <thead className="bg-black/40 text-slate-500 font-black uppercase">
                    <tr>
                      ...
                      <th className="p-10 border-b border-slate-800">Ressource / Quanta</th>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="bg-slate-900 border-2 border-blue-500/20 rounded-[3rem] overflow-hidden shadow-5xl h-full flex flex-col">
            <CardHeader className="p-10 border-b border-white/5 bg-blue-500/10 text-center">
              <Star className="h-12 w-12 text-blue-400 mx-auto mb-6 animate-spin-slow" />
              <CardTitle className="text-xl font-black uppercase text-white tracking-widest leading-none">Allocation de Précision</CardTitle>
            </CardHeader>
