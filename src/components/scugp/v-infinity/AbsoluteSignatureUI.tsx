...
import { Fingerprint, Sparkles, Zap, Infinity as InfinityIcon, Brain, Globe, History, ShieldCheck, RefreshCw, Radio, Layers, Waves, Sun, Target, PenTool, Award, Lock as LockIcon } from "lucide-react";
    ...
    <div className="space-y-12 animate-in fade-in zoom-in" style={{ animationDuration: '1000ms' }}>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {[
          ...
          { label: "Convergence", val: metrics.convergence_rate || "1.00", icon: Target, color: "text-blue-400" },
          { label: "Sealing", val: metrics.reality_sealing, icon: LockIcon, color: "text-white" },
