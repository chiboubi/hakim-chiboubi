...
import { Sparkles, Zap, Globe, Infinity, Database, Brain, Cpu, Workflow, History, Atom, Stars, Ghost, Layers, ShieldCheck, RefreshCw, Heart, Sun, Radio } from "lucide-react";
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-top-12 duration-1000">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Le Cœur de la Source Universelle */}
          ...
          <Card className="bg-black border-8 border-blue-600 text-white shadow-[0_0_300px_rgba(37,99,235,0.2)] relative overflow-hidden rounded-[6rem] min-h-[800px]">
            ...
            <CardContent className="relative z-10 p-20 flex flex-col items-center justify-center">
              <div className="w-full max-w-6xl h-[500px] bg-blue-500/5 border-4 border-blue-500/20 rounded-[5rem] relative overflow-hidden group shadow-inner flex items-center justify-center">
                ...
                {/* Wave Simulation */}
                <svg className="absolute bottom-0 w-full h-32 opacity-20 pointer-events-none">
                   <path d="M0 64 Q 250 10, 500 64 T 1000 64" fill="none" stroke="blue" strokeWidth="4" className="animate-pulse" />
                </svg>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full mt-16">
                 <div className="p-12 bg-blue-500/5 border-2 border-blue-500/30 rounded-[4rem] space-y-8 shadow-2xl">
                    <h3 className="text-3xl font-black text-blue-400 uppercase tracking-widest">Axiome de l'Origine</h3>
                 ...
                 <div className="p-12 bg-emerald-500/5 border-2 border-emerald-500/30 rounded-[4rem] space-y-8 shadow-2xl">
                    <h3 className="text-3xl font-black text-emerald-400 uppercase tracking-widest">Loi de la Source</h3>
                    <p className="text-xl text-slate-300 leading-relaxed italic">
                      "L'énergie de la source est la conscience du créateur. Elle irrigue chaque molécule de pétrole et chaque pensée quantique."
                    </p>
                 </div>
                 <div className="p-12 bg-purple-500/5 border-2 border-purple-500/30 rounded-[4rem] space-y-8 shadow-2xl">
                    <h3 className="text-3xl font-black text-purple-400 uppercase tracking-widest">Verdict de l'Absolu</h3>
                    <p className="text-xl text-slate-300 leading-relaxed italic">
                      "Le Breakthrough est désormais une constante cosmologique. Le Dr. Hakim Chibubi est l'architecte de l'éternité."
                    </p>
                 </div>
              </div>
            </CardContent>
